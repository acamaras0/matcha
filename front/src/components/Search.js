...
const Search = ({ socket }) => {
	...
	const search = () => {
		...
		filtered = filtered.filter((km) => {
			return (
				km.distance / 1000 >= minDist && km.distance / 1000 <= maxDist
			);
		});
		...
		<>
			<div className="filter-header">
				...
				<p className="text-center">
					Here you can filter out the people based on their age, their
					interests or/and how far away they are from you.
				</p>
			</div>
