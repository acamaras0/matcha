...
// VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
// db.query(test, ["John", "Doe", "John", "email@email.com" ,"$2b$10$K2V/gUHEzGkyidtb4KTBD.fXqZn39gWYaOm1ofVwq8GYunC21dDEm", "1", "18", "male", "music", "Bio", "60.192059", "24.945831", "3", "http://localhost:5000/upload/1.jpg", "1", "Helsinki", "Fi"], (err, result) => {
//   if (err) throw err;
...
// "INSERT INTO users (firstName, lastName, username, email, password, activ_status, birthdate, gender, interests, bio, geo_lat, geo_long, fame, profile_pic, online, city, country) \
// VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
// db.query(test1, ["Peter", "Son", "Peter", "email@email.com" ,"$2b$10$K2V/gUHEzGkyidtb4KTBD.fXqZn39gWYaOm1ofVwq8GYunC21dDEm", "1", "20", "male", "music", "Bio", "61.504967", "23.743065", "2", "http://localhost:5000/upload/2.jpg", "0", "Tampere", "Fi"], (err, result) => {
//     if (err) throw err;
...
// "INSERT INTO users (firstName, lastName, username, email, password, activ_status, birthdate, gender, interests, bio, geo_lat, geo_long, fame, profile_pic, online, city, country) \
// VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
// db.query(test3, ["Laura", "Palmer", "Laura", "email@email.com" ,"$2b$10$K2V/gUHEzGkyidtb4KTBD.fXqZn39gWYaOm1ofVwq8GYunC21dDEm", "1", "22", "female", "music", "Bio", "60.454510", "22.264824", "5", "http://localhost:5000/upload/4.jpg", "1", "Turku", "Fi"], (err, result) => {
//     if (err) throw err;
